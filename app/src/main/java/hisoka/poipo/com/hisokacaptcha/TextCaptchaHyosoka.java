...
/**
 * Created by Hyosoka Poipo on 5/18/2016.
 */
public class TextCaptchaHyosoka extends MainCaptchaHyosoka{
    ...
    public TextCaptchaHyosoka(int wordLength, TextOptions opt){
        new TextCaptchaHyosoka(0, 0, wordLength, opt);
    }

    public TextCaptchaHyosoka(int width, int height, int wordLength, TextOptions opt){
        setHeight(height);
        setWidth(width);
        this.options = opt;
